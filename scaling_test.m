...
hold on
alpha=1;
surf(num_counts_query,num_edges_query,time_inbuilt_edges_interp,'FaceAlpha',alpha,'FaceColor','r')
surf(num_counts_query,num_edges_query,time_ocsearch_interp,'FaceAlpha',alpha,'FaceColor','g')
surf(num_counts_query,num_edges_query,time_ucsearch_interp,'FaceAlpha',alpha,'FaceColor','b')
surf(num_counts_query,num_edges_query,time_bsearch_interp,'FaceAlpha',alpha,'FaceColor','m')
...
subplot(1,4,1)
was_one_of_mine_faster=min(cat(3,time_ocsearch_interp,time_bsearch_interp),[],3)<time_inbuilt_edges_interp;
